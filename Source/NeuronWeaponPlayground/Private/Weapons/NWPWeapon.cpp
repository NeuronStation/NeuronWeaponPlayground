...
void ANWPWeapon::LoadWeapon(TSubclassOf<class UNWPWeaponConfig> _WeaponConfig)
{
	...
	FNWPOnWeaponConfigLoadedDelegate OnWeaponCofigLoadedDelegate = FNWPOnWeaponConfigLoadedDelegate::CreateUObject(this, &ANWPWeapon::OnWeaponLoaded);
	CurrentWeaponConfig->LoadWeaponConfig(true, OnWeaponCofigLoadedDelegate);
}
